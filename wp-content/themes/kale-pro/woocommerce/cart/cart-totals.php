...
<div class="row">
    ...
    <ul class="list-total">
        ...
        <li class="cart-subtotal">
            <label><?php _e( 'Subtotal', 'kale' ); ?></label>
        ...
        <li class="shipping">
            <label><?php _e( 'Shipping', 'kale' ); ?></label>
        ...
        <?php if ( wc_tax_enabled() && ! WC()->cart->display_prices_including_tax() ) :
			...
			$estimated_text  = WC()->customer->is_customer_outside_base() && ! WC()->customer->has_calculated_shipping()
					? sprintf( ' <small>' . __( '(estimated for %s)', 'kale' ) . '</small>', WC()->countries->estimated_for_prefix( $taxable_address[0] ) . WC()->countries->countries[ $taxable_address[0] ] )
					: '';
