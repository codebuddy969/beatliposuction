...
function kale_meta_save_recipe_index($post_id) 
{
	...
	$categories_override = $new_data['categories_override'];
    
	if($categories_override != '') {
		$new_data['categories'] = $categories_override;
	} else if(is_array($post_categories)) {
		$new_data['categories'] = implode(',', $post_categories);
	}
