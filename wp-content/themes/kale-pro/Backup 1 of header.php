...
<div class="main-wrapper">
    <div class="container">
        ...
        <div class="header">
            ...
            <div class="header-row-2">
                ...
                <?php if( display_header_text() ) { ?>
					<p class="tagline-discover">Discover the secret to spot targeting your</p>
                <div class="tagline">
					<?php $tagline = get_bloginfo('description'); if($tagline != '') { ?>
					<p class="tagline-p"><?php echo esc_html($tagline); ?></p><?php } ?>
				</div>
                <?php } ?>
				</div>
				<div class="logo_right head_side_image">
					<img src="https://www.beatsliposuction.com/blog/wp-content/uploads/2018/09/NSS-AnimatedB4after-1.gif" class="custom-logo" alt="Chania">
				</div>
            </div>
            <!-- /Header Row 2 -->
		...
		<div class="sidebar-default sidebar-block sidebar-no-borders">
					...
					<center>
						<a target="_blank" href="http://beatsliposuction.com/liposuction-referral3-new.asp"><img src="https://www.beatsliposuction.com/blog/wp-content/uploads/2009/11/blogliposuctionalternative-300x191.jpg" width="175" height="125"></a>
						<p></p>
