...
function kale_widgets_init() {
	...
	register_sidebar( array(
		'name'          => __( 'Sidebar - Category - Bordered', 'kale' ),
		'id'            => 'sidebar-category-bordered',
		'before_widget' => '<div id="%1$s" class="category-widget widget widget-bordered %2$s">',
		'after_widget'  => '</div>',
		'before_title'  => '<h3 class="widget-title"><span>',
		'after_title'   => '</span></h3>',
	) );
    register_sidebar( array(
		'name'          => __( 'Sidebar - Category', 'kale' ),
		'id'            => 'sidebar-category',
		'before_widget' => '<div id="%1$s" class="category-widget widget %2$s">',
		'after_widget'  => '</div>',
		'before_title'  => '<h3 class="widget-title"><span>',
		'after_title'   => '</span></h3>',
	) );
	...
	if ( class_exists( 'WooCommerce' ) ) {
		...
		register_sidebar( array(
			'name'          => __( 'WooCommerce - Shop', 'kale' ),
			'id'            => 'sidebar-woocommerce',
			'before_widget' => '<div id="%1$s" class="woocommerce-widget widget %2$s">',
			'after_widget'  => '</div>',
			'before_title'  => '<h3 class="widget-title"><span>',
			'after_title'   => '</span></h3>',
		) );
		...
		register_sidebar( array(
			'name'          => __( 'WooCommerce - Shop - Bordered', 'kale' ),
			'id'            => 'sidebar-woocommerce-bordered',
			'before_widget' => '<div id="%1$s" class="woocommerce-widget widget widget-bordered %2$s">',
			'after_widget'  => '</div>',
			'before_title'  => '<h3 class="widget-title"><span>',
			'after_title'   => '</span></h3>',
		) );
		...
		register_sidebar( array(
			'name'          => __( 'WooCommerce - Product', 'kale' ),
		...
		register_sidebar( array(
			'name'          => __( 'WooCommerce - Product Category', 'kale' ),
			'id'            => 'sidebar-woocommerce-product-category',
			'before_widget' => '<div id="%1$s" class="woocommerce-widget widget %2$s">',
			'after_widget'  => '</div>',
			'before_title'  => '<h3 class="widget-title"><span>',
			'after_title'   => '</span></h3>',
		...
		register_sidebar( array(
			'name'          => __( 'WooCommerce - Checkout', 'kale' ),
			'id'            => 'sidebar-woocommerce-checkout',
			'before_widget' => '<div id="%1$s" class="woocommerce-widget widget %2$s">',
			'after_widget'  => '</div>',
			'before_title'  => '<h3 class="widget-title"><span>',
			'after_title'   => '</span></h3>',
