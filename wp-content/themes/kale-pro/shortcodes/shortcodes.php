...
<div class="lt-recipe" id="lt-recipe" itemscope itemtype="http://schema.org/Recipe">
    ...
    <div class="recipe-print">
        <a href="javascript:kale_print_recipe('lt-recipe');"><i class="fa fa-print"></i><?php _e('Print This', 'kale'); ?></a>
    </div>
    <?php } ?>
    <?php if($summary != '') { ?>
...
function lt_pt_words($value){
    ...
    if (class_exists('DateInterval')) {
        ...
        if($interval->h)  $str1 = $interval->h . __(' hr', 'kale');
        if($interval->i)  $str2 = $interval->i . __(' min', 'kale');
